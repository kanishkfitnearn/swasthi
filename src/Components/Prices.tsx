...
const Pricing = forwardRef<HTMLElement>((_, ref) => {
  useEffect(() => {
    AOS.init({
      ...
      once: false, // Animations will occur only once
    });
  }, []);

  return (
    <section ref={ref} className="flex flex-col md:flex-row justify-center items-center w-full h-auto md:h-[600px] gap-6 py-10">
